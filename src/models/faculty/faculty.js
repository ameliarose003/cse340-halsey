...
const getSortedFaculty = (sortBy) => {
    ...
    // I was confused so I had ai teach me what and how to do this:
    const validSortByParam = ['name', 'department', 'title'];
    const sortParam = validSortByParam.includes(sortBy) ? sortBy : 'department';
